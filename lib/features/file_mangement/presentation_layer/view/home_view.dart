...
import 'sub_filess_and_folders_view.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<FileMangementBloc>(
      create: (context) => sl()..add(GetFilesAndFoldersEvent()) ,
      child: Builder(
        builder: (context) {
          return  BlocConsumer<FileMangementBloc,FileMangementStates>(
            builder: (context,state) {
              if(state is LoadingState){
                ...
                if(state.data.length>0){
                  List path =state.data[0].path.split('/');
                  path.removeLast();
                  return Scaffold(
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            decoration:  InputDecoration(
                              ...
                              hintStyle: TextStyle(color: subtitleColor,fontSize: 13),focusedBorder:UnderlineInputBorder(borderSide: BorderSide(color: black.withOpacity(0.6)))
                            ),
                            cursorColor: blue,
                            onChanged: (value){
                         ...
                         DropdownButton<String>(
                            ...
                            dropdownColor: white,
                            iconSize: 0,
                            items: <String>[folders,files ].map((String value) {
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(path.last,style: TextStyle(color: blue),)
                                ],
                              ),
                            ),
                            Padding(
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: Text(editName,style: TextStyle(color: blue.withOpacity(0.8)),),
                                                                    ),
                                                                    Spacer()
                                                                  ],
                                                                ),
                            ...
                            return Dialog(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    IconButton(onPressed: (){Navigator.of(context).pop();}, icon: Icon(Icons.cancel_outlined,color: blue,)),
                                    TextField(controller: nameController,cursorColor: blue,decoration: InputDecoration(border: UnderlineInputBorder(borderSide: BorderSide(color: blue)),focusedBorder:UnderlineInputBorder(borderSide: BorderSide(color: blue)) ,hintText: 'name file or floder',hintStyle: TextStyle(color: black.withOpacity(0.26),fontSize: 14)),),
                                   Row(
                                     children: [
                                       Spacer(),
                                       Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                context.read<FileMangementBloc>().add(CreateFileEvent(state.data[0].path,nameController.text));
                                              ...
                                              child: Text(fileType,style: TextStyle(color: white,fontSize: 14),),
                                            ),
                                          ),
                                          ElevatedButton(
                                            onPressed: () {
                                              context.read<FileMangementBloc>().add(CreateFolderEvent(state.data[0].path,nameController.text));
                                              nameController.clear();
                                              Navigator.of(context).pop();
                                            },
                                            style: ElevatedButton.styleFrom(
                                            ...
                                            child: Text(folderType,style: TextStyle(color: white,fontSize: 14),),
                                          ),
                                          Spacer(),
                                        ],
                                      ),
            ...
            if(state is SuccessBoolState){
              context.read<FileMangementBloc>().add(GetFilesAndFoldersEvent());
            }
          });
        }
      )
